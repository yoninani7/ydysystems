...
<div class="page" id="p-org-chart">
  ...
  <div>
    <div class="page-title">Organizational Hierarchy</div>
    <div class="page-sub">Department structure with job positions and headcount</div>
  </div>
  <div class="flex-row" style="gap:10px;">
    <!-- Controls wrapper – hidden by default -->
    <div id="oc-controls-wrapper" style="display: none;">
      <div class="flex-row" style="gap:10px;">
        ...
        <button class="btn btn-primary" onclick="exportOrgChartPDF()"><i data-lucide="printer" size="14"></i> Export PDF</button>
      </div>
    </div>
  </div>
</div>
  
<!-- ORG CHART EMPTY STATE (centered with visible icon) -->
<div id="org-chart-empty" style="display: flex; align-items: center; justify-content: center; min-height: 450px; width: 100%;">
  <div class="att-empty-glass-card">
    <div class="att-empty-icon-stack">
      ...
      <div class="icon-main" style="background: var(--primary); color: #ffffff;">
   ...
   <button class="btn-generate-org" id="btn-generate-org" onclick="generateOrgChart()">
  <i data-lucide="sitemap" size="18"></i>
  <span>Generate Organizational Chart</span>
